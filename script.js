...
const translations = {
  en: {
    ...
    skill_group_languages: "Programming Languages",
    skill_group_languages_desc: "Programming languages",
    skill_group_app_development: "Application Development",
    skill_group_app_development_desc: "Application development",
    skill_group_cybersecurity: "Cybersecurity",
    skill_group_cybersecurity_desc: "Cybersecurity practice",
    skill_platform_windows: "Windows Only",
    skill_tools: "Tools",
  ...
  vi: {
    ...
    skill_group_languages: "Ngôn ngữ lập trình",
    skill_group_languages_desc: "Các ngôn ngữ lập trình",
    skill_group_app_development: "Phát triển ứng dụng",
    skill_group_app_development_desc: "Phát triển ứng dụng",
    skill_group_cybersecurity: "An ninh mạng",
    skill_group_cybersecurity_desc: "Thực hành an ninh mạng",
    skill_platform_windows: "Chỉ tấn công trên Windows",
    skill_tools: "Công cụ",
