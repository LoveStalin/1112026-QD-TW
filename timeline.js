...
const translations = {
  ...
  vi: {
    ...
    Decemberof2025: "<h2>12/2025</h2> <p>Trong tháng 12, chúng mình tiếp tục hành trình chơi bóng rổ. Đội bóng rổ Hạc Sẹo ngày càng mạnh mẽ, và chúng mình cũng vậy. Chúng mình bắt đầu tập luyện nghiêm túc hơn, với Chương là người lãnh đạo anh em. Chúng mình tham gia một giải đấu trường học và tiến đến vòng chung kết. Chúng mình giành chức vô địch trong giải đấu, đánh bại 1 đội lớp 12 trong trận chung kết.</p>",
  }
};
let currentLang = "en";
